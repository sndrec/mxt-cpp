...
public:
	...
	void debug_draw(float draw_time = 0.01666666f)
	{
		...
		dd3d->call("draw_line", p1, p2, godot::Color(1.0f, 1.0f, 1.0f), draw_time);
		dd3d->call("draw_line", p1 + b1[0] * rx1, p2 + b2[0] * rx2, godot::Color(1.0f, 1.0f, 1.0f), draw_time);
		dd3d->call("draw_line", p1 + b1[1] * ry1, p2 + b2[1] * ry2, godot::Color(1.0f, 1.0f, 1.0f), draw_time);
		dd3d->call("draw_line", p1 + b1[0] * -rx1, p2 + b2[0] * -rx2, godot::Color(1.0f, 1.0f, 1.0f), draw_time);
		dd3d->call("draw_line", p1 + b1[1] * -ry1, p2 + b2[1] * -ry2, godot::Color(1.0f, 1.0f, 1.0f), draw_time);

		dd3d->call("draw_arrow", p1, p1 + b1[0] * 6, godot::Color(1.0f, 0.5f, 0.5f), 0.25, true, draw_time);
		dd3d->call("draw_arrow", p1, p1 + b1[1] * 6, godot::Color(0.5f, 1.0f, 0.5f), 0.25, true, draw_time);
		dd3d->call("draw_arrow", p1, p1 + b1[2] * 6, godot::Color(0.5f, 0.5f, 1.0f), 0.25, true, draw_time);

		dd3d->call("draw_arrow", p2, p2 + b2[0] * 12, godot::Color(0.5f, 0.0f, 0.0f), 0.125, true, draw_time);
		dd3d->call("draw_arrow", p2, p2 + b2[1] * 12, godot::Color(0.0f, 0.5f, 0.0f), 0.125, true, draw_time);
		dd3d->call("draw_arrow", p2, p2 + b2[2] * 12, godot::Color(0.0f, 0.0f, 0.5f), 0.125, true, draw_time);

		dd3d->call("draw_arrow", p1, p1 + start_plane.normal * 4, godot::Color(0.0f, 1.0f, 0.0f), 0.25, true, draw_time);
		dd3d->call("draw_arrow", p2, p2 + end_plane.normal * 4, godot::Color(1.0f, 0.0f, 0.0f), 0.25, true, draw_time);

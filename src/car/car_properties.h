...
public:
	...
	godot::StreamPeerBuffer serialize()
	{
		...
		out_buffer.put_float(tilt_corners[0].x);
		out_buffer.put_float(tilt_corners[0].y);
		out_buffer.put_float(tilt_corners[0].z);
		out_buffer.put_float(tilt_corners[1].x);
		out_buffer.put_float(tilt_corners[1].y);
		out_buffer.put_float(tilt_corners[1].z);
		out_buffer.put_float(tilt_corners[2].x);
		out_buffer.put_float(tilt_corners[2].y);
		out_buffer.put_float(tilt_corners[2].z);
		out_buffer.put_float(tilt_corners[3].x);
		out_buffer.put_float(tilt_corners[3].y);
		out_buffer.put_float(tilt_corners[3].z);
		out_buffer.put_float(wall_corners[0].x);
		out_buffer.put_float(wall_corners[0].y);
		out_buffer.put_float(wall_corners[0].z);
		out_buffer.put_float(wall_corners[1].x);
		out_buffer.put_float(wall_corners[1].y);
		out_buffer.put_float(wall_corners[1].z);
		out_buffer.put_float(wall_corners[2].x);
		out_buffer.put_float(wall_corners[2].y);
		out_buffer.put_float(wall_corners[2].z);
		out_buffer.put_float(wall_corners[3].x);
	...
	static PhysicsCarProperties deserialize(godot::StreamPeerBuffer *in_buffer)
	{
		...
		new_properties.tilt_corners[1].x = in_buffer->get_float();
		new_properties.tilt_corners[1].y = in_buffer->get_float();
		new_properties.tilt_corners[1].z = in_buffer->get_float();
		new_properties.tilt_corners[2].x = in_buffer->get_float();
		new_properties.tilt_corners[2].y = in_buffer->get_float();
		new_properties.tilt_corners[2].z = in_buffer->get_float();
		new_properties.tilt_corners[3].x = in_buffer->get_float();
		new_properties.tilt_corners[3].y = in_buffer->get_float();
		new_properties.tilt_corners[3].z = in_buffer->get_float();
		new_properties.wall_corners[0].x = in_buffer->get_float();
		new_properties.wall_corners[0].y = in_buffer->get_float();
		new_properties.wall_corners[0].z = in_buffer->get_float();
		new_properties.wall_corners[1].x = in_buffer->get_float();
		new_properties.wall_corners[1].y = in_buffer->get_float();
		new_properties.wall_corners[1].z = in_buffer->get_float();
		new_properties.wall_corners[2].x = in_buffer->get_float();
		new_properties.wall_corners[2].y = in_buffer->get_float();
		new_properties.wall_corners[2].z = in_buffer->get_float();

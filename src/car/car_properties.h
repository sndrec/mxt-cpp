...
enum CarStatId : uint16_t {
	...
	CAR_STAT_SHIFT_BOOST_COOLDOWN_STRENGTH,
	CAR_STAT_DRIFT_ACCEL_BUILDUP_SECONDS,
	CAR_STAT_DRIFT_ACCEL_STRAFE_MULTIPLIER,
	CAR_STAT_SPIN_ATTACK_DAMAGE_MULTIPLIER,
	CAR_STAT_SIDE_ATTACK_DAMAGE_MULTIPLIER,
	CAR_STAT_ATTACK_KNOCKBACK_MULTIPLIER,
	CAR_STAT_ATTACK_COOLDOWN_SECONDS,
	CAR_STAT_SUSPENSION_STIFFNESS_MULTIPLIER,
	CAR_STAT_SUSPENSION_DAMPING_MULTIPLIER,
	CAR_STAT_RAIL_SPEED_RETENTION_MULTIPLIER,
	CAR_STAT_RAIL_DEFLECTION_MULTIPLIER,
...
static constexpr uint64_t MXT_CAR_PROPS_SCHEMA_FINGERPRINT = UINT64_C(0x31484ad2d3daf191);

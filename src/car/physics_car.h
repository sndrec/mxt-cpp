...
struct RoadData {
	...
	float tx;
	float ty;
	godot::Vector3 closest_point;
	godot::Vector3 closest_normal;
};
...
class PhysicsCar {
private:
	void get_closest_road_data_at_point(godot::Vector3 in_point, bool strict, RoadData* out_data);
	void cast_vs_world(CollisionData* out_data, godot::Vector3 p0, godot::Vector3 p1, uint8_t mask, int start_idx = 0, float radius = 0.0f);

	godot::Vector3 _normalized_safe(const godot::Vector3& vec, const godot::Vector3& default_vec = godot::Vector3()) const;
	godot::Vector3 _fit_plane_normal_with_reference(const godot::PackedVector3Array& points, const godot::Vector3& reference);
...
public:
	...
	CollisionData collision_scratch[8];
	...
	godot::Vector3 position_current = godot::Vector3(0.f, 0.f, 0.f);
	godot::Vector3 position_old = godot::Vector3(0.f, 0.f, 0.f);
	godot::Vector3 position_old_2 = godot::Vector3(0.f, 0.f, 0.f);
	godot::Vector3 position_old_dupe = godot::Vector3(0.f, 0.f, 0.f);
	godot::Vector3 position_bottom = godot::Vector3(0.f, 0.f, 0.f);
	godot::Vector3 position_behind = godot::Vector3(0.f, 0.f, 0.f);

	godot::Vector3 velocity = godot::Vector3(0.f, 0.f, 0.f);
	godot::Vector3 velocity_angular = godot::Vector3(0.f, 0.f, 0.f);
	godot::Vector3 velocity_local = godot::Vector3(0.f, 0.f, 0.f);
	godot::Vector3 velocity_local_flattened_and_rotated = godot::Vector3(0.f, 0.f, 0.f);
	...
	godot::Vector3 track_surface_normal = godot::Vector3(0.f, 1.f, 0.f);
	godot::Vector3 track_surface_normal_prev = godot::Vector3(0.f, 1.f, 0.f);
...
public:
	...
	void simulate_machine_motion(const PlayerInput& inputs = PlayerInput());
